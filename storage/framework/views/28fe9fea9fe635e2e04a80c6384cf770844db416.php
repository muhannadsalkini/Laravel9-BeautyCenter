    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" action="<?php echo e(route('admin_review_update',['id'=>$data->id])); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <table class="table sortable" id="categoryTable" >
                        ...
                        <tr>
                            <th>Name</th> <td><?php echo e($data->user->name); ?></td>
                        </tr>
                        <tr>
                            <th>Service</th> <td><?php if($data->service_id): ?> <?php echo e($data->service->title); ?> <?php else: ?> NO SERVICE! <?php endif; ?></td>
                        </tr>
                        <tr>
                            <th>Subject</th> <td><?php echo e($data->subject); ?></td>
                        </tr>
                        <tr>
                            <th>Review</th> <td><?php echo e($data->review); ?></td>
                        </tr>
                        <tr>
                            <th>Rate</th> <td><?php echo e($data->rate); ?></td>
                        </tr>
                        <tr>
...
<?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/review_edit.blade.php ENDPATH**/ ?>