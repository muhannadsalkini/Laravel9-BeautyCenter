                                ...
                                <div class="d-flex justify-content-between align-items-center mx-0 row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                            <label>Search:
                                                <input type="text" id='categoryInput' onkeyup='search()' placeholder="Search by subject.." class="form-control" aria-controls="DataTables_Table_0">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <table class="table sortable" id="categoryTable" >
                                    ...
                                    <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="item">
                                            ...
                                            <td><?php echo e(substr($rs->email,0,4)); ?>****</td>
                                            <td><?php echo e($rs->subject); ?></td>
                                            <td><?php if($rs->note): ?><?php echo e($rs->note); ?><?php else: ?> NO NOTE! <?php endif; ?></td>
                                            <td>
                                                <?php if($rs->status == "Read"): ?>
                                                        <span class="badge rounded-pill badge-light-primary me-1"><?php echo e($rs->status); ?></span>
                                                <?php else: ?>
                                                        <span class="badge rounded-pill badge-light-warning me-1">Not Read</span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="<?php echo e(route('admin_message_edit', ['id' => $rs->id])); ?>" onclick="return !window.open(this.href, '','top=50 left=100 width=1100, height=700')">
                                                            <i data-feather='eye'></i>
                                                            <span style="padding-left: 7px;">Read</span>
                                                        </a>
                                                        <a class="dropdown-item" href="<?php echo e(route('admin_message_delete', ['id' => $rs->id])); ?>" onclick="return confirm('Delete! Are you sure?');">
    ...
    <script>
        function search() {
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[3];  // Change tr[i].getElementsByTagName('td')"[0]" to "[number of row you want]" to set the row
                if (td) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/message.blade.php ENDPATH**/ ?>