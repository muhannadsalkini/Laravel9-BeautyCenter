                                ...
                                <div class="d-flex justify-content-between align-items-center mx-0 row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                            <label>Search:
                                                <input type="text" id='categoryInput' onkeyup='search()' placeholder="Search by service.." class="form-control" aria-controls="DataTables_Table_0">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <table class="table sortable" id="categoryTable" >
                                    ...
                                    <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="item">
                                            ...
                                            <td> <?php if($rs->service_id): ?> <a href="<?php echo e(route('service',['id'=> $rs->service_id])); ?>" target="_blank">
                                                <?php echo e($rs->service->title); ?></a> <?php else: ?> NO SERVICE! <?php endif; ?></td>
                                            ...
                                            <td>
                                                <?php
                                                $status = $rs->status;
                                                $temp = "badge rounded-pill badge-light-info me-1";
                                                if ($status == "True") {
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="<?php echo e(route('admin_review_show', ['id' => $rs->id])); ?>" onclick="return !window.open(this.href, '','top=50 left=100 width=1100, height=700')">
                                                            <i data-feather='eye'></i>
                                                            <span style="padding-left: 7px;">Show</span>
                                                        </a>
                                                        <a class="dropdown-item" href="<?php echo e(route('admin_review_delete', ['id' => $rs->id])); ?>" onclick="return confirm('Delete! Are you sure?');">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/review.blade.php ENDPATH**/ ?>