                    ...
                    <div class="blog-left-sidebar">
                        <article class="articles-details">
                            <div class="article-thumbnail">
                                <img src="<?php echo e(asset('assets')); ?>/images/blog/blog-details.jpg" alt="">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="s-article-gallery">
                                            <img src="<?php echo e(asset('assets')); ?>/images/blog/blog-action-1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="s-article-gallery">
                                            <img src="<?php echo e(asset('assets')); ?>/images/blog/blog-action-2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-4 hidden-sm col-xs-12">
                                        <div class="s-article-gallery">
                                            <img src="<?php echo e(asset('assets')); ?>/images/blog/blog-action-3.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="comment-box-inner fix">
                                    <div class="blog-comment fix">
                                        <div class="blog-comment-img">
                                            <img src="<?php echo e(asset('assets')); ?>/images/blog/comment-1.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="blog-comment reply fix">
                                        <div class="blog-comment-img">
                                            <img src="<?php echo e(asset('assets')); ?>/images/blog/blog-comment-2.jpg" alt="">
                                        </div>
                                        <div class="blog-comment-desc">
                                            <div class="comment-top-box">
                                                <div class="comment-title-box">
                            ...
                            <div class="recent-post">
                                <div class="single-recent-post mb-15">
                                    <div class="recent-post-thumbnail">
                                        <img src="<?php echo e(asset('assets')); ?>/images/blog/recent-1.jpg" alt="">
                                    </div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/home/blog.blade.php ENDPATH**/ ?>