                                ...
                                <table class="table sortable" id="categoryTable" >
                                    ...
                                    <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="item">
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar pull-up my-0">
                                                        <?php if($rs->profile_photo_path): ?>
                                                            <img src="<?php echo e(Storage::url($rs->profile_photo_path)); ?>"  height="26" width="26">
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><?php $__currentLoopData = $rs->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($row->name == "admin"): ?>
                                                    <span class="badge rounded-pill badge-light-primary me-1"><?php echo e($row->name); ?> </span>
                                                <?php else: ?>
                                                    <span class="badge rounded-pill badge-light-warning me-1"><?php echo e($row->name); ?> </span>
                                                <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('admin_user_roles',['id' => $rs->id])); ?>" onclick="return !window.open(this.href, '', 'top=50 left=100 width=800,height=600')">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="<?php echo e(route('admin_user_edit', ['id' => $rs->id])); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/user.blade.php ENDPATH**/ ?>