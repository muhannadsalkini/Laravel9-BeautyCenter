<?php $__env->startSection('title', 'Admin Panel FAQ'); ?>
                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="dt-action-buttons text-end">
                                        <div class="dt-buttons d-inline-flex">
                                            ...
                                            <button onclick="window.location.href='<?php echo e(route('admin_faq_add')); ?>'" type="button" class="btn btn-primary waves-effect waves-float waves-light">+ Add New Record</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mx-0 row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                            <label>Search:
                                                <input type="text" id='categoryInput' onkeyup='search()' placeholder="Search by question.." class="form-control" aria-controls="DataTables_Table_0">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="<?php echo e(route('admin_faq_edit', ['id' => $rs->id])); ?>">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('admin_faq_delete', ['id' => $rs->id])); ?>" onclick="return confirm('Delete! Are you sure?');">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/faq.blade.php ENDPATH**/ ?>