<?php $__env->startSection('title', 'Admin Panel Appointments'); ?>
<?php $__env->startSection('Appointment_status', 'active'); ?>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="<?php echo e(route('admin_appointment_show', ['id' => $rs->id])); ?>" onclick="return !window.open(this.href, '','top=50 left=100 width=1100, height=700')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/appointment.blade.php ENDPATH**/ ?>