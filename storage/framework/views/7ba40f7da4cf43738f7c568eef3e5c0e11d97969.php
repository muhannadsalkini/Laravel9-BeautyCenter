<?php $__env->startSection('title', 'Admin Panel Categories'); ?>
                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="dt-action-buttons text-end">
                                        <div class="dt-buttons d-inline-flex">
                                            ...
                                            <button onclick="window.location.href='<?php echo e(route('admin_category_add')); ?>'" type="button" class="btn btn-primary waves-effect waves-float waves-light">+ Add New Record</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar pull-up my-0" title="" data-bs-original-title="<?php echo e($rs->title); ?>">
                                                        <?php if($rs->image): ?>
                                                            <img src="<?php echo e(Storage::url($rs->image)); ?>" alt="" height="26" width="26">
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="<?php echo e(route('admin_category_edit', ['id' => $rs->id])); ?>">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('admin_category_delete', ['id' => $rs->id])); ?>" onclick="return confirm('Delete! Are you sure?');">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/category.blade.php ENDPATH**/ ?>