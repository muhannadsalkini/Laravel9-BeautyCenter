                ...
                <div class="col-md-12">
                    <div class="cart_list table-responsive">
                        <table class="table_cart table-bordered">
                            ...
                            <tr>
                                <td class="id">1</td>
                                <td class="product_img"><a href="#"><img alt="cart" src="<?php echo e(asset('assets')); ?>/images/cart/1.jpg"></a></td>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views\home\cart.blade.php ENDPATH**/ ?>