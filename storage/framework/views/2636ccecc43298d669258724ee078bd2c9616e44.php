<?php $__env->startSection('title', 'Admin Panel Add FAQ'); ?>
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" action="<?php echo e(route('admin_faq_store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-1">
                                <label class="form-label">Position</label>
                                <input type="number" name="position" class="<?php $__errorArgs = ['position'];
...
unset($__errorArgs, $__bag); ?> form-control" value="0" placeholder="Position">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" name="question" class="<?php $__errorArgs = ['question'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Php\Laravel9-BeautyCenter\resources\views/admin/faq_add.blade.php ENDPATH**/ ?>