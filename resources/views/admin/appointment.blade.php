...
@section('title', 'Admin Panel Appointments')
@section('Appointment_status', 'active')
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="{{route('admin_appointment_show', ['id' => $rs->id])}}" onclick="return !window.open(this.href, '','top=50 left=100 width=1100, height=700')">
