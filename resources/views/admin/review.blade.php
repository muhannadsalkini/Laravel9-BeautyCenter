                                ...
                                <table class="table sortable" id="categoryTable" >
                                    ...
                                    @foreach ($datalist as $rs)
                                        <tr class="item">
                                            <td>{{ $rs->id }}</td>
                                            <td>{{ $rs->user->name }}</td>
                                            <td> @if($rs->service_id) <a href="{{route('service',['id'=> $rs->service_id])}}" target="_blank">
                                                {{ $rs->service->title }}</a> @else NO SERVICE! @endif</td>
                                            <td>{{ $rs->subject }}</td>
                                            <td>{{ $rs->review }}</td>
                                            <td>{{ $rs->rate }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="{{route('admin_review_show', ['id' => $rs->id])}}" onclick="return !window.open(this.href, '','top=50 left=100 width=1100, height=700')">
                                                            <i data-feather='eye'></i>
                                                            <span style="padding-left: 7px;">Show</span>
                                                        </a>
                                                        <a class="dropdown-item" href="{{route('admin_review_delete', ['id' => $rs->id])}}" onclick="return confirm('Delete! Are you sure?');">
