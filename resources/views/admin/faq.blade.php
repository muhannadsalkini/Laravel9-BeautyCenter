                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="dt-action-buttons text-end">
                                        <div class="dt-buttons d-inline-flex">
                                            ...
                                            <button onclick="window.location.href='{{route('admin_faq_add')}}'" type="button" class="btn btn-primary waves-effect waves-float waves-light">+ Add New Record</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="{{route('admin_faq_edit', ['id' => $rs->id])}}">
                                                        ...
                                                        <a class="dropdown-item" href="{{route('admin_faq_delete', ['id' => $rs->id])}}" onclick="return confirm('Delete! Are you sure?');">
