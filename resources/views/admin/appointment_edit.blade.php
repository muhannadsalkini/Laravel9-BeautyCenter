    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" action="{{route('admin_appointment_update',['id'=>$data->id])}}" method="post">
                    @csrf
                    <table class="table sortable" id="categoryTable" >
                        ...
                        <tr>
                            <th>Service</th> <td> @if($data->service_id) <a href="{{ route('service', ['id'=>$data->service_id]) }}" target="_blank">{{ $data->service->title }}</a> @else NO SERVICE! @endif</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Appointment Date</th> <td>{{ $data->date }} / {{ $data->time }}</td>
                        </tr>
                        <tr>
