                                ...
                                <table class="table sortable" id="categoryTable" >
                                    ...
                                    @foreach ($datalist as $rs)
                                        <tr class="item">
                                            <td>{{ $rs->id }}</td>
                                            <td>{{ $rs->name }}</td>
                                            <td>{{substr($rs->email,0,4) }}****</td>
                                            <td>{{ $rs->subject }}</td>
                                            <td>@if($rs->note){{ $rs->note }}@else NO NOTE! @endif</td>
                                            <td>
                                                @if ($rs->status == "Read")
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"href="{{route('admin_message_edit', ['id' => $rs->id])}}" onclick="return !window.open(this.href, '','top=50 left=100 width=1100, height=700')">
                                                            <i data-feather='eye'></i>
                                                            <span style="padding-left: 7px;">Read</span>
                                                        </a>
                                                        <a class="dropdown-item" href="{{route('admin_message_delete', ['id' => $rs->id])}}" onclick="return confirm('Delete! Are you sure?');">
