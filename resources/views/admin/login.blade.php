...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets')}}/admin/app-assets/css/pages/page-auth.min.css">
    <!-- END: Page CSS-->
                ...
                <div class="auth-inner py-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <!-- form -->
                            <form class="auth-login-form mt-2" action="{{ route('admin_logincheck') }}" method="POST">
                                @csrf
                                <!-- e-mail -->
                                <div class="mb-1">
