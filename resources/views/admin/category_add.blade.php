        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" action="{{route('admin_category_create')}}" method="post">
                            @csrf
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                ...
                                <textarea name="description" class="form-control" id="validationBioBootstrap" rows="3"></textarea>
                            </div>
                            <div class="mb-1">
