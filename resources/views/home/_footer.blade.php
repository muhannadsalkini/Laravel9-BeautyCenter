            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="single-footer widget">
                        ...
                        <ul>
                            <li><a href="#"><img src="{{asset('assets')}}/images/widget/1.jpg" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('assets')}}/images/widget/2.jpg" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('assets')}}/images/widget/3.jpg" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('assets')}}/images/widget/4.jpg" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('assets')}}/images/widget/5.jpg" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('assets')}}/images/widget/6.jpg" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
